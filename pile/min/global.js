...
// file: highlight_pack_js_40ce283c57
...
// file: addanchor_jquery_coffee_fee94e74c3
(function() {
  var $;
  $ = jQuery;
  $.fn.addAnchor = function() {
    ...
    return this.each(function() {
      ...
      return that.before("<span class='anchor' id='" + finalId + "'> " + finalId + "  </span>");
    });
  };
}).call(this);
